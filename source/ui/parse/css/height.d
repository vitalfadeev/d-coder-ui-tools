module ui.parse.css.height;

import std.stdio : writeln;
import ui.parse.t.tokenize : Tok;


bool parse_height( Tok[] tokenized, ref string[] setters )
{
    ...
    if ( !args.empty )
    {
        ...
        {
            setters ~= format!"height = (%f).%s;"( length.length, length.unit );
            return true;
        }
    }
    else
    ...
    {
        import std.conv : to;
        assert( 0, "error: expect height args: " ~ tokenized.to!string );
        //return false;
    }
